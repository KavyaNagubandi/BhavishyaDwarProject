...
function sample(){
                       ...
                       <a className="navbar-brand" href="#"></a>
                        ...
                        <ul className="navbar-nav">
                            <li className="nav-item">
                                <br></br><a className="nav-link" href="index.html"><b style={{fontSize:"20px"}}>Home</b></a>
                            </li>
                            <li className="nav-item">
                                <br></br><a className="nav-link" href="aboutus.html"><b style={{fontSize:"20px"}}>AboutUs</b></a>
                            </li>
                            <li className="nav-item">
                                <br></br><a className="nav-link" href="contactus.html"><b style={{fontSize:"20px"}}> ContactUs</b></a>
                            </li>  
                        </ul>
                        </div>
                    </nav>
                              ...
                              <div className="collapse navbar-collapse" id="navbarNavDarkDropdown">
                                <ul className="navbar-nav">
                                  ...
                                  <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-info">
                                      <li><a className="dropdown-item" href="studentlogin.html">Student</a></li>
                                      <li><a className="dropdown-item" href="employerlogin.html">Employer</a></li>
                                    </ul>
                                  </li>
                                </ul>
                              </div>
    ...
    <main ><br></br>
        <div className="container">
          <div className="container" style={{borderStyle:"outset"}}><h3>Displaying Json data</h3>
        ...
        <table className="table border-dark">
          ...
          <h1 style={{fontFamily:"'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif",textAlign: "center" ,fontSize:"50px"}}>Looking for A Job?</h1> <br></br>
          <h2 style={{fontFamily:"fantasy", color:"rgb(5, 63, 105)", fontSize:"45px",textAlign:"center"}}>Register Now In Our Website Online!!</h2>
          <p style={{backgroundPosition:"500px",textAlign:"center"}} > 
          <img src="Employ.png" style={{ width:"500px", height:"600px"}}></img> </p>
          </div>    
    </main>
