...
<header>
    ...
    <main>
      <br></br>
      <div className="container" style={{fontFamily:"Calibri, Helvetica, sans-serif", borderStyle:"dashed"}}>
      <form>  
        <div className="container">  
        <center>  <h1> Student Registration Form</h1> </center>  
        <hr></hr>
        <label><b>Firstname</b>  <input type="text" name="firstname" placeholder= "Firstname" size="15" required /></label> &nbsp;&nbsp; 
      <label> <b>Middlename</b> <input type="text" name="middlename" placeholder="Middlename" size="15" required /> </label> &nbsp;
      ...
      <div>
        <label><b>Stream</b>&nbsp; &nbsp; &nbsp; <input type="text" name="Stream" placeholder="Enter Branch" required/></label>
      </div>
      <div>
        <label><b>Percentage</b><input type="text" name="Percentage" placeholder="Enter Percentage" required/> </label>
      </div>
      <div>  
      <label>  <b>Gender</b>  
      <br></br> 
      ...
      <textarea cols="50" rows="5" placeholder="Current Address" value="address" required>  
       ...
       <input type="text" placeholder="Enter Email" name="email" required />  
        ...
        <br/><br/>  <label for="psw-repeat"><b>Re-type Password</b></label>  
          <input type="password" placeholder="Retype Password" name="psw-repeat" required/><br/><br/>
          <b>Upload Your Image </b><input type="file" id="myFile" name="filename"/><br/><br/>
          <b>Upload Resume &nbsp; </b><input type="file" id="myFile" name="filename"/>
       <br/><center>   <button type="submit" className="registerbtn">Register</button>   </center> 
</div>
      </form>  <br/>
      </div><br/>
        <br/>
