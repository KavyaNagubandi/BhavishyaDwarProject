function Contactus(){
    ...
    <main>
        <div> 
            ...
            <h1 style={{color:"blue",fontFamily:"Cambria, Cochin, Georgia, Times, 'Times New Roman', serif", textAlign:"center"}}>Have any questions?</h1>
            <h3 style={{color:"indigo",textAlign:"center"}}>Reach out to Us</h3>
                    <br></br>
