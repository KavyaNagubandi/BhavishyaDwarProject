...
function Aboutus(){
    ...
    <main>
      <br></br>
        <div className="container" style={{borderStyle:"outset"}}>
         <br></br>  <h3 style={{color:"brown",textAlign:"center"}}><b>Welcome to Online Job Portal</b></h3>
           <p style={{fontFamily:"'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif", fontSize:"25px"}}><b>W</b>elcome to online Job Portal. It provides facility to the Job Seeker to search for various jobs as per his Qualififcation.Here Job Seeker can register himself on the web portal and create his profile along with his educational information.Job seeker can search various jobs and apply for the jobs.</p>
           <br></br>
           <p style={{fontFamily:"'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif", fontSize:"25px"}}>This Portal is also designed for the various employers who required to recruit  employees in their organisation. Employer can registered himself on the web portal and then he can upload information of various job vacancies in their organisation.</p>
        </div><br></br>
    </main>
